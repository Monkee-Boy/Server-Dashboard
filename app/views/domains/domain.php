  ...
  <div class="content active" id="panel1">
    <div class="row">
      <div class="large-6 columns">
        <div class="chartText current_bandwidth" width="100%" height="400px" data-chart-url="<?= route('chart_sum_bandwidth', array('domain_name'=>$domain_name)) ?>" data-chart-title="Total Bandwidth"></div>
      ...
      <div class="large-6 columns">
        <div class="chartText current_storage" width="100%" height="400px" data-chart-url="<?= route('chart_sum_storage', array('domain_name'=>$domain_name)) ?>" data-chart-title="Total Storage"></div>
